<!DOCTYPE html>
	<html lang="es">
		<head>
			<title>Velmondrill- Misión y Visión</title>
		...
		<!-- about -->
			<div class="services-w3ls">
				<div class="container">
					<h2 class="w3ls_head">Misión y <span>Visión</span></h2>
					<div class="agile_banner_bottom_grids">
						<div class="container">
							<div class="col-md-7 w3layouts_about_grid_left">
								<h4 align="center">Nuestra Misión</h4>
								<p align="justify">
									Proveer las empresas entrenamiento de calidad que cumpla con los estándares establecidos en los rubros en materia de Seguridad Industrial y Medio Ambiente, con el objetivo serio, de formar personal altamente calificado para realizar tareas en el ramo industrial altamente competitivo por medio de servicios de asesoría y capacitación, como nuestra más alta prioridad la integridad del personal y las instalaciones en los centros de trabajo.
								</p>
							</div>
							<div class="col-md-5 w3layouts_about_grid_left">
								<img src="images/sergio.webp" width="570" height="249" class="img-responsive" alt=""/>
							</div>
						</div>
						<br />
						<div class="container">
							<div class="col-md-7 w3layouts_about_grid_left">
								...
								<h4 align="center">Nuestra Visión</h4>
								<p align="justify">
									Proporcionar a nuestros clientes internos y externos las facultades de atender con responsabilidad las medidas preventivas de seguridad industrial y medio ambiente utilizando el desarrollo organizacional de tal manera que se implemente el entrenamiento y la asesoría recibida con la finalidad de garantizar la satisfacción total de nuestros clientes.
								</p>
							</div>
							<div class="col-md-5">
								<img src="images/entrenamiento.jpg" width="570" height="249" class="img-responsive" alt=""/>
							</div>
						</div>
						<div class="clearfix"> </div>
					</div>
