<!DOCTYPE html>
	<html lang="es">
		<head>
			<title>Velmondrill- Diplomados</title>
		...
		<!-- about -->
			<div class="services-w3ls">
				<div class="container">
					<h2 class="w3ls_head">Diplo<span>mados</span></h2>
					<div class="w3ls_testimonials_grids testimonials">
						<section class="center slider">
							<div class="agileits_testimonial_grid">
								<div class="w3l_testimonial_grid">
									<br />
									<p>DIPLOMADO EN FORMACIÓN DE SUPERVISORES DE SEGURIDAD QHSE.</p>
									<div class="w3l_testimonial_grid_pos">
										<img src="images/diplomado.png" class="img-responsive" alt=""/>
									</div>
								</div>
							</div>
							<div class="agileits_testimonial_grid">
								<div class="w3l_testimonial_grid">
									<br />
									<p>DIPLOMADOS EN IMPACTO AMBIENTAL.</p>
									<div class="w3l_testimonial_grid_pos">
										<img src="images/diplomado.png" class="img-responsive" alt=""/>
									</div>
								</div>
							...
							<div class="agileits_testimonial_grid">
								<div class="w3l_testimonial_grid">
									<br />
									<p>DIPLOMADO EN INGENIERÍA PETROLERA PARA NO PETROLEROS.</p>
									<div class="w3l_testimonial_grid_pos">
										<img src="images/diplomado.png" class="img-responsive" alt=""/>
									</div>
								</div>
							...
							<div class="agileits_testimonial_grid">
								<div class="w3l_testimonial_grid">
									<br />
									<p>DIPLOMADO EN PREVENCIÓN DE CORROSIÓN.</p>
									<div class="w3l_testimonial_grid_pos">
										<img src="images/diplomado.png" class="img-responsive" alt=""/>
									</div>
								</div>
							...
							<div class="agileits_testimonial_grid">
								<div class="w3l_testimonial_grid">
									<br />
									<p>DIPLOMADO EN PERFORACIÓN DE POZOS PETROLEROS.</p>
									<div class="w3l_testimonial_grid_pos">
										<img src="images/diplomado.png" class="img-responsive" alt=""/>
									</div>
								</div>
							...
							<div class="agileits_testimonial_grid">
								<div class="w3l_testimonial_grid">
									<br />
									<p>DIPLOMADOS EN FLUIDOS DE CONTROL (LODO DE PERFORACIÓN).</p>
									<div class="w3l_testimonial_grid_pos">
										<img src="images/diplomado.png" class="img-responsive" alt=""/>
									</div>
								</div>
