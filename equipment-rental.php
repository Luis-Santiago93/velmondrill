<!DOCTYPE html>
	<html lang="es">
		<head>
			<title>Velmondrill- Renta de Equipo</title>
		...
		<!-- about -->
			<div class="services-w3ls overview w3-2">
				<div class="container">
					<h2 class="w3ls_head">Renta de <span>Equipo</span></h2>
					<div class="agile-prod1">
						<div class="col-md-6 agile-sub">
							<h4>Equipo de seguridad industrial</h4>
						</div>
						<div class="col-md-6 agile-img">
							<img src="images/expo_ferre.jpg" class="img-responsive" alt=""/>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="agile-prod1">
						<div class="col-md-6 agile-img">
							<img src="images/ERA2.jpg" class="img-responsive" alt=""/>
						</div>
						<div class="col-md-6 agile-sub">
							<h4>Equipos de Respiración Autónoma</h4>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="agile-prod1">
						<div class="col-md-6 agile-sub">
							<h4>Detectores de Gases &nbsp;&nbsp;&nbsp;</h4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
						<div class="col-md-6 agile-img">
							<img src="images/GAS.jpg" class="img-responsive" alt=""/>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="agile-prod1">
						<div class="col-md-6 agile-img">
							<img src="images/extintores.jpg" class="img-responsive" alt=""/>
						</div>
						<div class="col-md-6 agile-sub">
							<h4>Extintores</h4>&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
					...
					<div class="agile-prod1">
						<div class="col-md-6 agile-sub">
							<h4>Venta y renta de equipo de protección persona</h4>
						</div>
						<div class="col-md-6 agile-img">
							<img src="images/protecionpersonal.jpg" class="img-responsive" alt=""/>
						</div>
						<div class="clearfix"> </div>
					</div>
						<div class="agile-prod1">
						<div class="col-md-6 agile-img">
							<img src="images/Seg.jpg" class="img-responsive" alt=""/>
						</div>
						<div class="col-md-6 agile-sub">
							<h4>Suministro de personal outsourcing</h4>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
