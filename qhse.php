	...
	<html lang="es">
		...
		<!-- about -->
			<div class="services-w3ls overview w3-2">
				<div class="container">
					<h2 class="w3ls_head">QH<span>SE</span></h2>
					<center>
						<img src="images/HSE.png" width="1024" height="462">
					</center>
					<br />
					<div class="container w3layouts_about_grid_left">
					<p align="justify">
						En la actualidad, las organizaciones y empresas de éxito deben responder de forma eficiente a un conjunto de requisitos que abarca distintas áreas tales como: Seguridad Industrial, Salud Ocupacional, Protección Ambiental y Gestión de Calidad, todo ello relacionado en la prestación de servicios o productos. Todos estos se encuentran reunidos en las siglas QHSE.
					</p>
					<p align="justify">
						QHSE son las siglas en inglés de <em>Quality, Health, Safety and Environment</em>, en español, <em>Calidad, Salud, Seguridad y Medio Ambiente</em>.
					</p>
					<p align="justify">
						En la industria actual es de gran importancia cumplir una serie de requisitos en tema de Seguridad, Conservación Medioambiental e Inspección de la calidad. Para todas las entidades y trabajadores esto es un tema de gran relevancia, para evitar que cualquier trabajador de la organización sufra algún accidente en su entorno laboral.
					</p>
					<P align="justify">
						Nuestros servicios aquí en <a href="index.php"><span style="color: #ff0000"><b>Velmondrill</b></span></a> en matería de Calidad, Seguridad y Medio Ambiente tiene como objetivo cumplir los requerimientos necesarios que las normas nacionales e internacionales certifican dichos procesos y proveedores, así como brindar condiciones seguras de trabajo a sus colaboradores y promover la responsabilidad social enfocada al cuidado al medio ambiente.
					</p>
					</div>
