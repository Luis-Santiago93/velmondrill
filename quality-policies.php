...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<title>Velmondrill- Políticas de Calidad</title>
		...
		<!-- about -->
			<div class="services-w3ls">
				<div class="container">
					<h2 class="w3ls_head">Políticas de <span>Calidad</span></h2>
							...
							<div class="panel-group" id="accordion">
							  <div class="panel panel-default">
								...
								<div id="collapse1" class="panel-collapse collapse in">
								  <div class="panel-body"><p ALIGN="justify">Que todo nuestro personal de entrenamiento tenga como cultura principal el uso de recursos de la seguridad industrial y medio ambiente siendo su más alta prioridad.</p></div>
								</div>
							  </div>
							  <div class="panel panel-default">
								<div class="panel-heading">
								...
								<div id="collapse2" class="panel-collapse collapse">
								  <div class="panel-body"><p ALIGN="justify">A todo el personal con la finalidad de mantener, cumplir , y dar un paso siempre adelante para futuros eventos no deseados, teniendo un plan de acción que permita minimizar y administrar los riesgos potenciales de trabajo.</p></div>
								</div>
							  </div>
							  <div class="panel panel-default">
								<div class="panel-heading">
								...
								<div id="collapse3" class="panel-collapse collapse">
								  <div class="panel-body"><p ALIGN="justify"> En cada situación no deseada con responsabilidad y habilidad para minimizar de manera inmediata, segura y eficiente toda acción o condición insegura, que pueda llegar a causar daños al personal y daños a la instalación de trabajo.</p></div>
								</div>
							  </div>
							</div>
						</div>
