...
<html lang="es">
	<head>
		<title>Velmondrill- Reseña Histórica</title>
	...
	<!-- about -->
		<div class="services-w3ls">
			<div class="container">
				<h2 class="w3ls_head">Reseña <span>Histórica</span></h2>
				<div class="agile_banner_bottom_grids">
					<div class="col-md-6 w3layouts_about_grid_left">
						<h4>Más de 23 años de experiencia en el sector energético y del petróleo</h4>
						<p ALIGN="justify">En <font color='#dd3333'><strong>Velmondrill S.A. de C.V. </strong></font> contamos con una amplia experiencia en el sector energético y del petróleo. El cual nos ha permitido tener una experiencia laboral en países como <em>Argentina, Venezuela, Chile, Estados Unidos y en Medio Oriente como Arabia Saudita, Omán, Argelia, y por supuesto en México</em>, en proyectos de extracción de hidrocarburos para proyectos terciarios y mesozoicos, con experiencias en empresas como <em>Weatherford, Schlumberger, Halliburton</em> entre otras.
						Convencidos de que la Seguridad Salud en el trabajo y Protección ambiental son nuestra más alta prioridad, siendo esta una condición de empleo.
						</p>
					</div>
					<div class="col-md-6 w3layouts_about_grid_right">
						<!--<iframe src="https://www.youtube.com/watch?v=iDGvJ2e0Hlo"></iframe> -->
						<iframe  src="https://www.youtube.com/embed/iDGvJ2e0Hlo" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
