...
<!DOCTYPE html>
	<html lang="es">
		<head>
			<title>Velmondrill- Objetivos de Calidad</title>
		...
		<!-- about -->
			<div class="services-w3ls">
				<div class="container">
					<h2 class="w3ls_head">Objetivos de <span>Calidad</span></h2>
					<div class="agile_banner_bottom_grids">
						<div class="w3layouts_about_grid_left" align="justify">
							<p>
								Desde sus orígenes, la empresa se ha preocupado por desarrollar programas de capacitación y certificación de acuerdo a los requisitos legales que rigen el ramo de la Seguridad industrial basado en las entidades establecidas por Red CONOCER (SEP), STPS, SSPA en México.
							</p>
							<hr />
							<div class="panel-title">
								<h4>
									Nuestros objetivos de calidad están sustentados con los siguientes compromisos de acción:
								</h4>
							</div>
							<div class="services-grids">
								<div class="col-md-6 services-grid">
									...
									<div class="services-right well">
										<p>Actualizar permanentemente los programas de formación para dar una respuesta de calidad a la demanda de los sectores energético, industrial y petrolero.</p>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="col-md-6 services-grid">
									...
									<div class="services-right well">
										<p>Formar con herramientas de competencia laboral a profesionistas, técnicos, supervisores, ingenieros, sin profesión, con el conocimiento necesario adecuado para los cambios en el sector del petróleo, haciéndolos cada día más eficientes y competitivos los cuales tendrán carácter para poderse distinguir entre los trabajadores mediante su esfuerzo y compromiso en temas de seguridad industrial.</p>
									</div>
									<div class="clearfix"></div>
								</div>
								<div class="clearfix"></div>
