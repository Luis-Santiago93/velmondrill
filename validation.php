<!DOCTYPE html>
	<html lang="es">
		<head>
			<title>Velmondrill- Validación de Programa</title>
			...
			<script src="js/controller/validaprograma.js"></script>
			<!-- Required-js -->
					  ...
					  <div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							...
							<li><a class="active" href="validation.php">Validación</a></li>
		...
		<!-- about -->
			<div class="services-w3ls">
				<div class="container">
						<h2 class="w3ls_head">Validación de <span>Programa</span></h2>
						<div class="panel panel-danger">
						  <div class="panel-heading">&nbsp;&nbsp;</div>
						  <div class="panel-body">
							<ul class="nav nav-tabs">
							  <li class="active"><a data-toggle="tab" href="#home">Búsqueda</a></li>
							  <li><a data-toggle="tab" href="#menu1">Resultados</a></li>
							</ul>

							<div class="tab-content">
							  <div id="home" class="tab-pane fade in active"><br>
								<h2>Datos de consulta</h2><br>
								<form class="form-inline" id="formconsulta" method="POST" onsubmit="return false;">
								  <div class="form-group">
									<label for="programa">NO. de Programa:</label>
									<input type="text" class="form-control" id="programa" required>
								  </div>
								  <button type="submit" class="btn btn-danger btn-lg" id="btnConsultar">Consultar</button>
								</form>
							  </div>
							  <div id="menu1" class="tab-pane fade"><br>
								<h2>Resultados</h2><br>
								<table class="table table-striped" style="font-size: 120%" data-paging="true" data-sorting="true" data-filtering="true" id="validacion">
									<thead>
									  <tr>
										<th style="text-align: left"><strong>Numero de Programa</strong></th>
										<th style="text-align: left"><strong>Nombre</strong></th>
										<th style="text-align: left"><strong>Curso</strong></th>
										<th style="text-align: left"><strong>Fecha</strong></th>
										<th style="text-align: left"><strong>Vigencia</strong></th>
										<th style="text-align: left"><strong>Estatus</strong></th>
									  </tr>
									</thead>
									<tbody id="content">
									</tbody>
