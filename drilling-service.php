<!DOCTYPE html>
	<html lang="es">
		<head>
			<title>Velmondrill- Drilling Service</title>
					  ...
					  <div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							...
							<li class="dropdown">
							  <a class="active dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Conocenos <span class="caret">
		...
		<!-- about -->
			<div class="services-w3ls">
				<div class="container services-grids">
					<h2 class="w3ls_head">Drilling <span>Service</span></h2>
					<center>
						<img src="images/equipamiento.jpg" width="1024" height="462" />
					</center>
					<br />
					<div class="container w3layouts_about_grid_left">
						<p align="justify">
							El petróleo se encuentra a gran profundidad, en general a tres mil hasta cuatro mil metros, mas sin embargo existen pozos de cinco mil e incluso pueden llegar a tener seis mil metros de profundidad. Conforme con la profundidad proyectada del pozo, las formaciones que se marchan a atravesar y las condiciones propias del subsuelo, se escoge los equipos de perforación más indicados.
						</p>
						<br />
						<div class="col-md-6" >
						<center><h4 class="panel-title">PERFORACIÓN DE POZOS</h4></center>
						<p align="justify">
							La perforación así como la exploración, son un tipo de actividad que demanda mucho tiempo y también recursos financieros. De ahí que, un equipo de perforación solo se instala y empieza a perforar solo cuando geofísicos y geólogos han acordado la ubicación más capaz para buscar hidrocarburos ubicados en el subsuelo.
						</p>
						<br />
						<img src="images/perforacion.jpg" width="540" height="234" />
						</div>
						<div class="col-md-6 ser-grid">
						<center><h4 class="panel-title">SERVICIOS DE PERFORACIÓN</h4></center>
						<p align="justify">
							 <a href="index.php"><span style="color: #ff0000"><b>Velmondrill</b></span></a> ofrece las mejores capacitaciones y cursos sobre diferentes tipos de servicios integrales de perforación, algunas de ellos son:
						</p>
						<ul>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Ingeniería y diseño de pozos.</li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Construcción y perforación de pozos petroleros.</li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Perforación direccional y horizontal.</li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Perforación bajo balance y control de presión.</li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Equipos de perforación, reparación y tubería flexible propios.</li>
							<li><i class="fa fa-arrow-right" aria-hidden="true"></i>Equipos auto-transportables tipo “Pulling”, para terminación y conversión de aparejos de producción de pozos.</li>
						</ul>
						<p align="justify">
							Es evidente que con los diferentes programas de perforación no solo aumentan las recuperaciones de tiempo y dinero, si no que también reducen los costos al minimizar el tiempo improductivo, de la misma manera aumentar las tasas de producción y requerir menores gastos de capital.
						</p>
						</div>
					</div>
				</div>
